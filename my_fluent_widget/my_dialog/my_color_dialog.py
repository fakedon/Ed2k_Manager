...
from qfluentwidgets import Slider, ScrollArea, PrimaryPushButton
from qfluentwidgets.components.dialog_box.color_dialog import MaskDialogBase
...
class myColorDialog(MaskDialogBase):
    """ Color dialog """
    ...
    def __init__(self, color, title: str, parent=None, enableAlpha=False):
        ...
        self.redLabel = QLabel(self.tr('红色'), self.scrollWidget)
        self.blueLabel = QLabel(self.tr('蓝色'), self.scrollWidget)
        self.greenLabel = QLabel(self.tr('绿色'), self.scrollWidget)
        self.opacityLabel = QLabel(self.tr('透明度'), self.scrollWidget)
